...
export function Button({
  ...
  const defaultClassName = `group inline-block px-6 py-3 text-sm no-underline uppercase text-center text-white tracking-wider font-medium md:font-semibold rounded-full bg-violet-600 hover:bg-violet-700 transition-all min-w-[100px] duration-200 ease-out hover:text-white hover:no-underline undefined ${className}`;
